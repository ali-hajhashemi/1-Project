    ...
    <div class="showcase-content">
      ...
      <div class="showcase-content-sliders">
        ...
        <div class="showcase-slide">
          <div class="showcase-slide-bg" style="background-image: url(/assets/img/48.jpg)"></div>
          <div class="showcase-slide-detail">
            <!-- Pre-heading -->
            <div class="showcase-slide-preheading">
              <span>BY SIMPLEQODE</span>
            </div>
            <!-- Heading -->
            <div class="showcase-slide-heading">
              <h1>Landing pages for any occasion</h1>
            </div>
            <!-- Sub-heading -->
        ...
        <!-- Slide -->
        <div class="showcase-slide">
          <div class="showcase-slide-bg" style="background-image: url(/assets/img/49.jpg)"></div>
          <div class="showcase-slide-detail">
            <!-- Pre-heading -->
            <div class="showcase-slide-preheading">
              <span>BY SIMPLEQODE</span>
            ...
            <div class="showcase-slide-subheading">
              <p>
                Create beautiful websites from scratch with multiple pre-built
                pages and styled components.
              </p>
            </div>
            <!-- Button -->
            <div class="showcase-slide-button">
        ...
        <!-- Slide -->
        <div class="showcase-slide">
          <div class="showcase-slide-bg" style="background-image: url(/assets/img/50.jpg)"></div>
          <div class="showcase-slide-detail">
            <!-- Pre-heading -->
            <div class="showcase-slide-preheading">
              <span>BY SIMPLEQODE</span>
            ...
            <!-- Heading -->
            <div class="showcase-slide-heading">
              <h1>Build anything with Incline</h1>
            </div>
            <!-- Sub-heading -->
            <div class="showcase-slide-subheading">
              <p>
